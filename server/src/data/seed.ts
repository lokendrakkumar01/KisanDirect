...
import { MAHARASHTRA_LOCATIONS } from './locations';
...
export const fpoProfiles: FPOProfile[] = [
...
// Listings
export const listings: CropListing[] = [
...
// Bulk Requirements
export const bulkRequirements: BulkRequirement[] = [
