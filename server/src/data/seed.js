...
export const listings = [
    { id: uuidv4(), farmerId: users[0].id, farmerName: 'Ramesh Patil', farmName: 'Ramesh Farms', productName: 'Fresh Red Tomatoes', category: 'vegetables', description: 'Freshly picked Grade A red tomatoes directly from Nashik farm.', quantity: 500, availableQuantity: 500, unit: 'kg', price: 25, minOrderQuantity: 10, qualityGrade: 'A', organic: true, harvestDate: NOW, availableFrom: NOW, images: ['https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=600&auto=format&fit=crop&q=80'], image: 'https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=600&auto=format&fit=crop&q=80', location: MAHARASHTRA_LOCATIONS.NASHIK, rating: 4.8, totalReviews: 24, sellerType: 'farmer', status: 'active', createdAt: NOW, updatedAt: NOW },
    { id: uuidv4(), farmerId: users[0].id, farmerName: 'Ramesh Patil', farmName: 'Ramesh Farms', productName: 'Nashik Red Onions', category: 'vegetables', description: 'Export quality red onions from Lasalgaon mandi.', quantity: 1000, availableQuantity: 800, unit: 'kg', price: 30, minOrderQuantity: 50, qualityGrade: 'A', organic: false, harvestDate: NOW, availableFrom: NOW, images: ['https://images.unsplash.com/photo-1618512496248-a07fe83aa8cf?w=600&auto=format&fit=crop&q=80'], image: 'https://images.unsplash.com/photo-1618512496248-a07fe83aa8cf?w=600&auto=format&fit=crop&q=80', location: MAHARASHTRA_LOCATIONS.NASHIK, rating: 4.6, totalReviews: 35, sellerType: 'farmer', status: 'active', createdAt: NOW, updatedAt: NOW },
    { id: uuidv4(), farmerId: users[1].id, farmerName: 'Sunil Shinde', farmName: 'Sunil Orchards', productName: 'Seedless Grapes', category: 'fruits', description: 'Sweet export-grade seedless green grapes from Niphad vineyard.', quantity: 200, availableQuantity: 150, unit: 'kg', price: 80, minOrderQuantity: 5, qualityGrade: 'A', organic: false, harvestDate: NOW, availableFrom: NOW, images: ['https://images.unsplash.com/photo-1537640538966-79f369143f8f?w=600&auto=format&fit=crop&q=80'], image: 'https://images.unsplash.com/photo-1537640538966-79f369143f8f?w=600&auto=format&fit=crop&q=80', location: MAHARASHTRA_LOCATIONS.NIPHAD, rating: 4.9, totalReviews: 36, sellerType: 'farmer', status: 'active', createdAt: NOW, updatedAt: NOW },
];
// Bulk Requirements
