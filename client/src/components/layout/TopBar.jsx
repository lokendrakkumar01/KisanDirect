            ...
            <div className="flex items-center justify-between px-4 sm:px-6 lg:px-8 h-16">
                ...
                <div className="flex-1 px-4 flex justify-end">
                    <div className="max-w-md w-full hidden md:block">
                        <div className="relative">
                            ...
                            <input 
                                className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg leading-5 bg-gray-50 placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-green-500 focus:border-green-500 sm:text-sm transition duration-150 ease-in-out" 
                                placeholder="Search marketplace, orders, crop insights..." 
                                type="search"
                            />
                        </div>
                    </div>
                ...
                <div className="flex items-center ml-4 space-x-4">
                    <Link to="/notifications" className="relative p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:text-gray-500">
                        ...
                        {unreadCount > 0 && (
                            <span className="absolute top-0 right-0 block h-4 w-4 rounded-full bg-red-500 text-white text-xs font-bold text-center leading-4 shadow-sm ring-2 ring-white">
                    ...
                    <div className="relative flex items-center space-x-3">
                        ...
                        <button onClick={logout} className="p-1.5 text-gray-400 hover:text-red-600 transition-colors rounded hover:bg-red-50" title="Logout">
