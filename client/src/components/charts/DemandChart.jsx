...
export const DemandChart = ({ data, isPrototype = true }) => {
    return (<div className="w-full h-80">
      ...
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={data} margin={{ top: 5, right: 20, left: 0, bottom: 5 }}>
          ...
          <Legend />
          <Line type="monotone" dataKey="predictedDemand" name="Predicted Demand (Qtl)" stroke="#10B981" strokeWidth={3} dot={{ r: 4, fill: '#10B981', strokeWidth: 0 }} activeDot={{ r: 6 }}/>
        </LineChart>
      </ResponsiveContainer>
    </div>);
};
