...
export const MapView = ({ center, zoom = 6, markers, className = 'h-96' }) => {
    return (<div className={`w-full rounded-xl overflow-hidden border border-gray-200 z-0 ${className}`}>
      <MapContainer center={center} zoom={zoom} style={{ height: '100%', width: '100%' }}>
        ...
        {markers.map((marker) => (<Marker key={marker.id} position={[marker.location.lat, marker.location.lng]} icon={icons[marker.type]}>
            <Popup>
