    ...
    return (<div className="max-w-3xl mx-auto space-y-6">
      ...
      <Card>
        <CardContent className="p-0 divide-y">
          {notifications.map(n => (<div key={n.id} className={`p-4 flex gap-4 hover:bg-gray-50 transition-colors ${!n.read ? 'bg-blue-50/50' : ''}`}>
              <div className="mt-1">
              ...
              {!n.read && (<div className="flex items-center">
