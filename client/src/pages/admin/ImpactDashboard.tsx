    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500">Measuring the socio-economic impact of KisanDirect</p>
        </div>
      ...
      <div className="bg-blue-50 border border-blue-200 text-blue-800 px-4 py-3 rounded-lg text-sm mb-6">
        <strong>Note for SIH Judges:</strong> These metrics are prototype simulations for demonstration purposes to showcase the potential impact of the KisanDirect platform at scale.
      </div>
