                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <button
                      ...
                      className={`flex flex-col items-center p-4 border-2 rounded-xl transition-all ${
                        role === 'farmer' ? 'border-green-600 bg-green-50 text-green-700' : 'border-gray-200 text-gray-600 hover:border-gray-300'
                      }`}
                    >
                    ...
                    <button
                      ...
                      onClick={() => setRole('fpo')}
                      className={`flex flex-col items-center p-4 border-2 rounded-xl transition-all ${
                        role === 'fpo' ? 'border-blue-600 bg-blue-50 text-blue-700' : 'border-gray-200 text-gray-600 hover:border-gray-300'
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`flex flex-col items-center p-4 border-2 rounded-xl transition-all ${
                        role === 'consumer' ? 'border-amber-500 bg-amber-50 text-amber-700' : 'border-gray-200 text-gray-600 hover:border-gray-300'
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`flex flex-col items-center p-4 border-2 rounded-xl transition-all ${
                        role === 'bulk_buyer' ? 'border-purple-600 bg-purple-50 text-purple-700' : 'border-gray-200 text-gray-600 hover:border-gray-300'
                      }`}
                    >
