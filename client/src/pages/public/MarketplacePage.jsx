        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
            ...
            <div className="relative w-full md:w-96">
              <input type="text" placeholder="Search crops, vegetables..." className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)}/>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-2">
                      {['Vegetables', 'Fruits', 'Grains', 'Pulses'].map(cat => (<label key={cat} className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      {['A', 'B', 'C'].map(grade => (<button key={grade} className="px-3 py-1 border border-gray-300 rounded-md text-sm hover:bg-green-50 hover:border-green-500 focus:bg-green-50 focus:border-green-500">
                          {grade}
                        </button>))}
                    </div>
                  </div>
            ...
            <div className="flex-1">
              ...
              {isLoading ? (<div className="flex flex-col items-center justify-center py-20">
                ...
                </div>) : listings.length === 0 ? (<div className="bg-white p-10 rounded-xl border border-gray-200 text-center">
                  <p className="text-gray-500 text-lg">No listings found matching your criteria.</p>
                </div>) : (<div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                  {listings.map(listing => (<Link key={listing.id} to={`/marketplace/product/${listing.id}`} className="group bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-lg transition flex flex-col">
                      <div className="h-48 bg-gradient-to-br from-green-100 to-amber-50 flex items-center justify-center relative">
                        ...
                        {listing.organic && (<div className="absolute top-3 left-3 bg-green-600 text-white text-xs font-bold px-2 py-1 rounded shadow-sm flex items-center">
                      ...
                      <div className="p-5 flex-1 flex flex-col">
                        ...
                        <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-100">
                          <div className="flex items-center">
                            {listing.sellerType === 'fpo' ? (<Award className="w-4 h-4 mr-1 text-blue-500"/>) : (<div className="w-5 h-5 rounded-full bg-gray-200 mr-2 flex items-center justify-center text-xs">👨‍🌾</div>)}
              ...
              {/* Pagination */}
              {!isLoading && listings.length > 0 && (<div className="flex justify-center mt-10">
