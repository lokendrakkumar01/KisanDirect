      ...
      <div className="bg-white min-h-screen pt-12 pb-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            <h1 className="text-4xl font-extrabold text-gray-900 mb-4">About KisanDirect</h1>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-8 text-white shadow-lg mb-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-blue-100 leading-relaxed mb-4">
                KisanDirect is built as a prototype solution for the Smart India Hackathon 2026. 
