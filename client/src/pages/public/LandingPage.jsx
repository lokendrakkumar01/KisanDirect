...
import { Leaf, TrendingUp, Truck, Shield, Users, BarChart3, ArrowRight, Zap } from 'lucide-react';
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">AgroConnect AI connects supply with demand instantly.</p>
              </div>
