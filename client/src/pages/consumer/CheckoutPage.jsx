...
export const CheckoutPage = () => {
    ...
    if (success) {
        return (<Card className="max-w-2xl mx-auto text-center py-12 px-6">
          ...
          <Card className="sticky top-6">
            ...
            <CardBody className="p-6">
              <div className="space-y-4 mb-6">
                {items.map(item => (<div key={item.listingId} className="flex justify-between text-sm">
              ...
              <div className="py-4 border-t border-gray-100">
                ...
                <PriceBreakdown farmerRealization={subtotal} logistics={logisticsEstimate} platformFee={platformFee} total={total}/>
              </div>
              ...
              <div className="mt-6">
                <Button fullWidth size="lg" onClick={handlePlaceOrder} isLoading={loading} disabled={!address.name || !address.phone || !address.address}>
                  Place Order - {formatCurrency(total)}
                </Button>
                <p className="text-xs text-center text-gray-500 mt-3">
                  By placing your order, you agree to AgroConnect's Terms of Service and Privacy Policy.
                </p>
              </div>
            </CardBody>
          </Card>
