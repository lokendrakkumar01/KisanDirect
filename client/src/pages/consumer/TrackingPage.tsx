...
export const TrackingPage: React.FC = () => {
  ...
  const history = [
    { status: 'confirmed' as any, timestamp: new Date(Date.now() - 86400000).toISOString() },
    { status: 'pickup_scheduled' as any, timestamp: new Date(Date.now() - 43200000).toISOString() },
    { status: 'picked_up' as any, timestamp: new Date(Date.now() - 7200000).toISOString() },
    { status: 'in_transit' as any, timestamp: new Date(Date.now() - 3600000).toISOString(), note: 'Left distribution center' }
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-1 space-y-6">
          <Card>
            ...
            <CardBody>
              <StatusTimeline currentStatus={orderDetails.status as any} history={history} />
            </CardBody>
          </Card>
