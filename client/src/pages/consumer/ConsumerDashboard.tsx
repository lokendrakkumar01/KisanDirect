      ...
      <div className="bg-green-600 rounded-2xl p-8 text-white flex flex-col md:flex-row justify-between items-center shadow-lg">
        <div className="mb-6 md:mb-0">
          ...
          <div className="relative max-w-md">
            <input 
              type="text" 
              placeholder="Search for tomatoes, onions, wheat..." 
              className="w-full pl-12 pr-4 py-3 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-green-300 shadow-sm"
            />
