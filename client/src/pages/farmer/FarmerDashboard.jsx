...
export const FarmerDashboard = () => {
    ...
    return (<div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <StatCard title="Active Orders" value={3} // Mock
     icon={<TrendingUp className="w-6 h-6"/>}/>
      ...
      {insight && (<Card className="border-green-200 bg-green-50 overflow-hidden">
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardBody className="space-y-4">
              {data?.harvests.length > 0 ? (data.harvests.map((harvest) => (<div key={harvest.id} className="flex justify-between items-center p-3 hover:bg-gray-50 rounded-lg border border-gray-100">
                    <div>
                  ...
                  </div>))) : (<p className="text-gray-500 text-sm text-center py-4">No upcoming harvests.</p>)}
            </CardBody>
          </Card>
        </div>
      </div>
