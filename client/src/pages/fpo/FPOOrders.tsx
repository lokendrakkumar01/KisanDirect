...
import { Search, Filter, Truck, CheckCircle2, AlertCircle } from 'lucide-react';
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <div className="flex flex-col gap-2 justify-end">
                      ...
                      {order.status === 'Delivered' && order.payment === 'Paid' && (
                        <Button size="sm" className="h-8 bg-green-600 hover:bg-green-700">Distribute Payout</Button>
                      )}
                      {order.status === 'Processing' && (
                        <Button size="sm" className="h-8">Dispatch</Button>
                      )}
                    </div>
                  </td>
                </tr>
