...
import { Users, Package, ShoppingCart, IndianRupee, AlertCircle, PlusCircle, Layers } from 'lucide-react';
                ...
                <div key={agg.id} className="p-4 border rounded-lg hover:bg-gray-50">
                  ...
                  <div className="mt-3">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div 
                        className={`h-2 rounded-full ${agg.current >= agg.target ? 'bg-green-500' : 'bg-primary-500'}`} 
